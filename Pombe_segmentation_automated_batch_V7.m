...
%std_thresh =1800;
%int_thresh = 
prompt_dlg = {'H factor', 'Erode Diameter', 'Dilate Diameter', 'Sensitivity Threshold', 'Min Area Threshold','Eccentricity Threshold','Max Intensity Threshold','Folder Name','Filename'};
dlg_title = 'Parameters';
dim_box = [1,50];
definput = {'4','1','3','0.70','100','0.00','40000','Segmented Files','BF'};
...
cell_Bin_stats = regionprops(bw6, rd2, 'MaxIntensity');
 ...
 num_rev = length(cell_int_thresh);
   ...
   cc_bin2 = bwconncomp(bw6);
   label_bin = labelmatrix(cc_bin2);
