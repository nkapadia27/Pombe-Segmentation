...
prompt_dlg = {'H factor', 'Erode Diameter', 'Dilate Diameter', 'Sensitivity Threshold', 'Min Area Threshold','Eccentricity Threshold','Max Intensity Thresh'};
dlg_title = 'Parameters';
dim_box = [1,50];
definput = {'4','1','3','0.70','100','0.0','29000'};
...
% big_thresh = ~big_thresh; 
 big_thresh = bwareafilt(big_thresh, [min_size,10000000]);
...
bw4 = bw2;
bw4(Ld2 == 0) = 0;
bw4 = bwareafilt(bw4, [min_size, 5000000]);
figure,imshow(bw4)
bw5=bw4;
