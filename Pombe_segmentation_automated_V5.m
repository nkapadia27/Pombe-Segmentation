...
prompt_dlg = {'H factor', 'Erode Diameter', 'Dilate Diameter', 'Sensitivity Threshold', 'Min Area Threshold','Eccentricity Threshold'};
dlg_title = 'Parameters';
dim_box = [1,50];
definput = {'4','1','3','0.70','400','0.70'};
...
adapt_sens_thresh = str2num(user_input_seg{4});%default 0.7
%% 
